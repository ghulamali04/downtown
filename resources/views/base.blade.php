...
<head>
    ...
    <link href="{{ asset('/') }}assets/libs/select2/css/select2.css" rel="stylesheet">
    <link href="{{ asset('/') }}assets/libs/select2-bootstrap4-theme/select2-bootstrap4.css" rel="stylesheet">
...
<body>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{Auth::user()->first_name . ' ' . Auth::user()->last_name}}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{route('account.settings')}}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Account Settings</span></a>
                        <a class="dropdown-item" href="javascript:;" onclick="document.getElementById('logoutForm').submit();"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
        ...
        <div class="main-content">
            ...
            <footer class="footer border-top">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Downtown.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by <a href="https://bitzsol.com">Bitzsol</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('/')}}assets/libs/jquery-validation/jquery.validate.js"></script>
