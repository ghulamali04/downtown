                ...
                <form method="POST" action="{{ route('order.update', ['order' => $order->id]) }}">@csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('table_number') is-invalid @enderror" name="table_number" value="{{$order->table_number}}" placeholder="Table Number">
                            @error('table_number')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="row" data-repeater-item>
                                    <div class="col-sm-6 mb-3">
                                        <select class="form-select select2" name="item">
                                            ...
                                            <option value="{{$item->id}}" {{$item->id == @$oldItem->menu_item_id ? 'selected' : ''}}>{{$item->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
