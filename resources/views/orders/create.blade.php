                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-12 mb-3">
                            ...
                            <select class="form-select select2 @error('table_number') is-invalid @enderror" name="table_number">
                                ...
                                @for ($i = 1; $i <= 20; $i++)
                                    <option value="G{{$i}}" {{old('table_number') == 'G'.$i ? 'selected' : ''}}>G{{$i}}</option>
                                @endfor
                                @for ($i = 1; $i <= 20; $i++)
                                    <option value="F{{$i}}" {{old('table_number') == 'F'.$i ? 'selected' : ''}}>F{{$i}}</option>
                                @endfor
                                @for ($i = 1; $i <= 50; $i++)
                                    <option value="T{{$i}}" {{old('table_number') == 'T'.$i ? 'selected' : ''}}>T{{$i}}</option>
                                @endfor
                            </select>
                            @error('table_number')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
