...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
            <h4 class="mb-sm-0">Inventory Item</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Inventory Item</a></li>
                </ol>
            </div>
    ...
    <div class="col-xxl-12">
        <div class="card ">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Inventory Item</h4>
                <div class="flex-shrink-0">
                    <a class="btn btn-primary" href="{{route('item.create')}}">Create New</a>
                </div>
            </div><!-- end card header -->
            <div class="card-body ">
    ...
    const table = $("#thisTable").DataTable({
        ...
        "columns": [
            ...
            { "data": "description" },
            {
                ...
                "render": function (data, type, row) {
                    return `
                        <a class="tracking-btn text-dark" href="javascript:;" data-id="${data}">
                                    <i class="  ri-eye-line ri-2xl"></i>
                                    </a>
        ...
        $(document).ready(function () {
            $(document).on('click', '.tracking-btn', function () {
                ...
                window.location.href='{{url('inventory/tracking')}}?item_id='+id
            });
            $(document).on('click', '.edit-btn', function () {
                const id = $(this).data('id');
                window.location.href= '{{url('inventory/item')}}/'+id+'/edit'
            });
